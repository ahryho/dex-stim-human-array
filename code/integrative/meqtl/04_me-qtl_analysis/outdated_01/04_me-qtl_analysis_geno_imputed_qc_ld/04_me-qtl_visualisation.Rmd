...
The __SNP data__ first underwent QC analysis:
...
After genotype QC, __100'085 SNPs__ were included in the meQTL study.
...
For cis-QTL analyses, false discovery rate (FDR) of 1% was chosen. 
...
ggplot(plt.df, aes(x = Frequency, fill = treatment)) + 
  geom_histogram(aes(color = treatment), bins = 5, alpha = 0.5) +
  theme(legend.position = "none", 
        legend.title = element_blank(),
        panel.grid.major = element_blank(),
        panel.background = element_blank(),
