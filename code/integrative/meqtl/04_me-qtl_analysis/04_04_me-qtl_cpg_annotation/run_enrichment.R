...
fwrite(gen.loc.enrich.perm.rslt, 
       file = paste0("~/bio/code/mpip/dex-stim-human-array/output/data/integrative/matrixEQTL/05_me-qtl_enrichment/region_wise_independent_snps/",  "meqtl_cpgs_relation_to_island_enrichment_perm_delta_vs_all.csv"), 
       row.names = F, quote = F)
