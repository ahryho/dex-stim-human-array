...
GetVennPlt(meqtl.df = parallel.fc.grp.veh.dex.cpg, eqtm.df = eqtm.all.nom.df, cbPal.col = "#999999")
```

### Parallel FC: delta

```{r out.width = "95%", include = T, eval = T, fig.cap = "Number of intersections, CpGs \n delta with parallel FC"}
GetVennPlt(meqtl.df = parallel.fc.grp.delta.cpg, eqtm.df = eqtm.all.nom.df, cbPal.col = "#999999")
```

### Opposite FC

```{r out.width = "95%", include = T, eval = T, fig.cap = "Number of intersections, CpGs \n opposite FC"}
GetVennPlt(meqtl.df = opposite.fc.grp.cpg, eqtm.df = eqtm.all.nom.df, cbPal.col = "#999999")
```