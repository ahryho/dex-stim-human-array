...
```{r incldue = F, eval = T}
epic.anno.fn <- "~/bio/code/mpip/dex-stim-human-array/output/data/methylation/02_dmp/dex_cpgs_annotated.csv"
...
ggplot(bcc.melt.df, aes(y = value, x = variable, fill = Status)) +
  geom_boxplot() +
  scale_fill_viridis(discrete = TRUE, alpha = 0.3, option = "C") +
  labs(title = " ", y = "DNAm blood cell type estimation", x = " ") +
