...
ind.meqtl.dex.df <- meqtl.dex.df[SNP %in% c(snp.dex.lst$SNP, snp.delta.lst$SNP)]

fwrite(ind.meqtl.dex.df[, -7], 
       "~/bio/code/mpip/dex-stim-human-array/output/data/integrative/matrixEQTL/me-qtl_cis_indp_result_dex_with_delta_fdr_005.csv",
...
ind.meqtl.veh.df <- meqtl.veh.df[SNP %in% c(snp.veh.lst$SNP, snp.delta.lst$SNP)] # left_join(snp.veh.lst, meqtl.veh.df)

fwrite(ind.meqtl.veh.df[, -7], 
       "~/bio/code/mpip/dex-stim-human-array/output/data/integrative/matrixEQTL/me-qtl_cis_indp_result_veh_with_delta_fdr_005.csv",
       quote = F, row.names = F, sep = ";")
```
