...
***
# __Identification of independent meQTLs: region-wise vs. global__
***
...
meqtl.dex.cpg.snp.ass     <- paste0(out.dir.pre, "region_wise_independent_snps/me-qtl_cis_delta_ind_cpg_snp_associations.txt")

meqtl.dex.cpg.snp.ass.lst <- fread(meqtl.dex.cpg.snp.ass) 
...
```{r include = F, eval = T}
meqtl.delta.ind.rw.df <- left_join(meqtl.dex.cpg.snp.ass.lst, meqtl.delta.df)
