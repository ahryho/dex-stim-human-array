***
## The data from DC with window = 200 and shift  = 100
***
...
plink --bfile qc/subset/dex_imputed_bggt_all_qc --indep-pairwise 200 100  0.2 --out ld_200_100/ld/dex_geno_imputed_ld
```
...
Options in effect:
  ...
  --out ld_200_100/dex_geno_imputed_ld

64168 MB RAM detected; reserving 32084 MB for main workspace.
3936233 variants loaded from .bim file.
293 people (0 males, 0 females, 293 ambiguous) loaded from .fam.
Ambiguous sex IDs written to ld_200_100/dex_geno_imputed_ld.nosex .
Using 1 thread (no multithreaded calculations invoked).
Before main variant filters, 293 founders and 0 nonfounders present.
Calculating allele frequencies... done.
...
3936233 variants and 293 people pass filters and QC.
Note: No phenotypes present.
Pruned 298326 variants from chromosome 1, leaving 7856.
Pruned 333815 variants from chromosome 2, leaving 7814.
Pruned 284343 variants from chromosome 3, leaving 6875.
Pruned 286636 variants from chromosome 4, leaving 6269.
Pruned 261752 variants from chromosome 5, leaving 6212.
Pruned 252109 variants from chromosome 6, leaving 6053.
Pruned 223682 variants from chromosome 7, leaving 5499.
Pruned 214207 variants from chromosome 8, leaving 4978.
Pruned 167122 variants from chromosome 9, leaving 4680.
Pruned 208835 variants from chromosome 10, leaving 5313.
Pruned 203878 variants from chromosome 11, leaving 5049.
Pruned 190181 variants from chromosome 12, leaving 5104.
Pruned 152902 variants from chromosome 13, leaving 3861.
Pruned 128697 variants from chromosome 14, leaving 3472.
Pruned 101768 variants from chromosome 15, leaving 3166.
Pruned 97849 variants from chromosome 16, leaving 3267.
Pruned 85402 variants from chromosome 17, leaving 3094.
Pruned 108793 variants from chromosome 18, leaving 3259.
Pruned 64939 variants from chromosome 19, leaving 2443.
Pruned 74525 variants from chromosome 20, leaving 2524.
Pruned 53168 variants from chromosome 21, leaving 1585.
Pruned 43220 variants from chromosome 22, leaving 1711.
Pruning complete.  3836149 of 3936233 variants removed.
Marker lists written to ld_200_100/dex_geno_imputed_ld.prune.in and
ld_200_100/dex_geno_imputed_ld.prune.out .
```

2. Generate genome file for MDS

```{sh imputed-ld-pruning-extract-darina, eval = F}
plink --bfile qc/subset/dex_imputed_bggt_all_qc --extract ld_200_100/ld/dex_geno_imputed_ld.prune.in --make-bed --out ld_200_100/pca/ld_extracted/dex_geno_imputed_ld
```
...
Options in effect:
  --bfile qc/subset/dex_imputed_bggt_all_qc
  --extract ld_200_100/ld/dex_geno_imputed_ld.prune.in
  --make-bed
  --out ld_200_100/pca/ld_extracted/dex_geno_imputed_ld

64168 MB RAM detected; reserving 32084 MB for main workspace.
3936233 variants loaded from .bim file.
293 people (0 males, 0 females, 293 ambiguous) loaded from .fam.
Ambiguous sex IDs written to
ld_200_100/pca/ld_extracted/dex_geno_imputed_ld.nosex .
--extract: 100084 variants remaining.
Using 1 thread (no multithreaded calculations invoked).
Before main variant filters, 293 founders and 0 nonfounders present.
Calculating allele frequencies... done.
Total genotyping rate is 0.995226.
100084 variants and 293 people pass filters and QC.
Note: No phenotypes present.
--make-bed to ld_200_100/pca/ld_extracted/dex_geno_imputed_ld.bed +
ld_200_100/pca/ld_extracted/dex_geno_imputed_ld.bim +
ld_200_100/pca/ld_extracted/dex_geno_imputed_ld.fam ... done.
```

### __MDS with PLINK__

```{sh imputed-pca-darina,  eval = F}
plink --bfile ld_200_100/pca/ld_extracted/dex_geno_imputed_ld  --cluster --mds-plot 293 'eigvals' 'eigendecomp' --out ld_200_100/pca/mds/dex_geno_imputed_ld_mds
```
...
Options in effect:
  --bfile ld_200_100/pca/ld_extracted/dex_geno_imputed_ld
  --cluster
  --mds-plot 293 eigvals eigendecomp
  --out ld_200_100/pca/mds/dex_geno_imputed_ld_mds

64168 MB RAM detected; reserving 32084 MB for main workspace.
100084 variants loaded from .bim file.
293 people (0 males, 0 females, 293 ambiguous) loaded from .fam.
Ambiguous sex IDs written to ld_200_100/pca/mds/dex_geno_imputed_ld_mds.nosex .
...
Clustering... done.
Cluster solution written to ld_200_100/pca/mds/dex_geno_imputed_ld_mds.cluster1
, ld_200_100/pca/mds/dex_geno_imputed_ld_mds.cluster2 , and
ld_200_100/pca/mds/dex_geno_imputed_ld_mds.cluster3 .
Performing multidimensional scaling analysis (eigendecomposition algorithm,
293 dimensions)... done.
MDS solution written to ld_200_100/pca/mds/dex_geno_imputed_ld_mds.mds
(eigenvalues in ld_200_100/pca/mds/dex_geno_imputed_ld_mds.mds.eigvals ).
```
...
scp -C -r -o ProxyCommand="ssh cluser@biocomp.psych.mpg.de nc slurmgate 22" ahryhorzhevska@slurmgate:/binder/mgp/workspace/2020_DexStim_Array_Human/snps/imputed_qc/from_darina/ .
```
