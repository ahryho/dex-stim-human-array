...
beta.mtrx.fn    <- "/home/ahryhorzhevska/mpip/bio/code/mpip/dex-stim-human-array/data/integrative/matrixEQTL/methyl_beta_mtrx_"
pheno.fn        <- "/home/ahryhorzhevska/mpip/bio/code/mpip/dex-stim-human-array/data/pheno/pheno_full_for_kimono.csv"
lmer.res.out.fn <- "/home/ahryhorzhevska/mpip/bio/code/mpip/dex-stim-human-array/output/data/integrative/matrixEQTL/dnam_residuals/dnam_residuals"
# fwrite(pheno, 
#        pheno.fn,
#        row.names = F,
#        quote = F,
