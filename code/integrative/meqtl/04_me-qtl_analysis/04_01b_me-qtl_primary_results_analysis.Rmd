...
```{r, include = F, eval = T}
src.dir.pre  <- "~/bio/code/mpip/dex-stim-human-array/data/integrative/matrixEQTL/ensg_locations.csv"
...
# fwrite(meqtl.all.full.df, 
#        paste0(out.dir.pre, "meqtl_cis_result_veh_dex_delta_fdr_005.csv"),
...
saveRDS(meqtl.opposite.fc.grp.veh.dex.gr, file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_snp_anno_parallel_fc_grp_veh_dex_gr.rds"))
...
saveRDS(meqtl.opposite.fc.grp.delta.gr, file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_snp_anno_parallel_fc_grp_delta_gr.rds"))
...
meqtl.opposite.fc.grp.veh.dex.gr <- readRDS(file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_snp_anno_parallel_fc_grp_veh_dex_gr.rds"))
meqtl.opposite.fc.grp.delta.gr   <- readRDS(file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_snp_anno_parallel_fc_grp_delta_gr.rds"))
...
ggplot(anno.stat.df, aes(x = Frequency, fill = Model, color = Model)) + 
...
wilcox.test.rslt <- pairwise.wilcox.test(anno.stat.df$Frequency, anno.stat.df$Model, p.adjust.method = "none", paired = F)$p.value %>% signif(3)
...
wilcox.test.rslt <- pairwise.wilcox.test(anno.stat.df$Frequency, anno.stat.df$Model, p.adjust.method = "none", paired = T)$p.value %>% signif(3)
...
```{r out.width = "95%", include = T, eval = T}
anno.stat.df[["LogFreq"]] <- log10(anno.stat.df$Frequency)

ggplot(anno.stat.df, aes(x = LogFreq, fill = Model, color = Model)) + 
  geom_density(alpha = 0.2) +
  theme(legend.position = c(.9,.9), 
        legend.title = element_blank(),
        panel.grid.major = element_blank(),
...
t.test.rslt <- pairwise.t.test(anno.stat.df$LogFreq, anno.stat.df$Model, p.adjust.method = "none", paired = F)$p.value %>% signif(3)

colnames(t.test.rslt) <- c("parallel FC (delta)", "opposite FC")
rownames(t.test.rslt) <- c("opposite FC", "parallel FC (veh&dex)")
t.test.rslt

print("Paired t-test: ")

t.test.rslt <- pairwise.t.test(anno.stat.df$LogFreq, anno.stat.df$Model, p.adjust.method = "none", paired = T)$p.value %>% signif(3)
...
saveRDS(meqtl.opposite.fc.grp.veh.dex.gr, file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_cpg_anno_parallel_fc_grp_veh_dex_gr.rds"))
...
saveRDS(meqtl.opposite.fc.grp.delta.gr, file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_cpg_anno_parallel_fc_grp_delta_gr.rds"))
...
meqtl.opposite.fc.grp.veh.dex.gr <- readRDS(file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_cpg_anno_parallel_fc_grp_veh_dex_gr.rds"))
meqtl.opposite.fc.grp.delta.gr   <- readRDS(file =  paste0(out.dir.pre, "meqtl_overlaps_meqtl_level_cpg_anno_parallel_fc_grp_delta_gr.rds"))
...
<!-- meqtls.cpg.anno.df <- data.frame(anno.epic[anno.epic$Name %in% overlaps.all, ]) %>% setDT() -->
<!-- fwrite(meqtls.cpg.anno.df, -->
<!--        paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_delta_dex_veh.csv"), -->
<!--        quote = F, row.names = F, sep   = "\t") -->

<!-- meqtls.cpg.anno.df <- data.frame(anno.epic[anno.epic$Name %in% overlaps.delta.veh, ]) %>% setDT() -->
<!-- fwrite(meqtls.cpg.anno.df, -->
<!--        paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_delta_veh.csv"), -->
<!--        quote = F, row.names = F, sep   = "\t") -->

<!-- meqtls.cpg.anno.df <- data.frame(anno.epic[anno.epic$Name %in% overlaps.delta.dex, ]) %>% setDT() -->
<!-- fwrite(meqtls.cpg.anno.df, -->
<!--        paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_delta_dex.csv"), -->
<!--        quote = F, row.names = F, sep   = "\t") -->

<!-- meqtls.cpg.anno.df <- data.frame(anno.epic[anno.epic$Name %in% only.delta, ]) %>% setDT() -->
<!-- fwrite(meqtls.cpg.anno.df, -->
<!--        paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_only_delta.csv"), -->
<!--        quote = F, row.names = F, sep   = "\t") -->
...
<!-- ovarlap.all.cpg.anno.df <- fread(paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_delta_dex_veh.csv"), sep = "\t") -->
<!-- ovarlap.delta.dex.cpg.anno.df <- fread(paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_delta_dex.csv"), sep = "\t") -->
<!-- ovarlap.delta.veh.cpg.anno.df <- fread(paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_delta_veh.csv"), sep = "\t") -->
<!-- only.delta.cpg.anno.df <- fread(paste0(out.dir.pre, "meqtl_overlaps_cpg_level_cpg_anno_only_delta.csv"), sep = "\t") -->
<!-- ``` -->

<!-- ```{r include = F, eval = T} -->
<!-- ovarlap.all.cpg.anno.df[["Model"]] <- paste0("intersect \n (delta, veh, dex)\nN = ", nrow(ovarlap.all.cpg.anno.df))  -->
<!-- ovarlap.delta.dex.cpg.anno.df[["Model"]] <- paste0("intersect \n (delta, dex)\nN=", nrow(ovarlap.delta.dex.cpg.anno.df))  -->
<!-- ovarlap.delta.veh.cpg.anno.df[["Model"]] <- paste0("intersect \n (delta, veh)\nN=", nrow(ovarlap.delta.veh.cpg.anno.df))  -->
<!-- only.delta.cpg.anno.df[["Model"]] <- paste0("only delta\nN", nrow(only.delta.cpg.anno.df))  -->

<!-- meqtl.cpg.anno.df <- rbind(ovarlap.all.cpg.anno.df, ovarlap.delta.dex.cpg.anno.df, ovarlap.delta.veh.cpg.anno.df, only.delta.cpg.anno.df) -->

<!-- meqtl.cpg.anno.df$Model <- as.factor(meqtl.cpg.anno.df$Model) -->
<!-- meqtl.cpg.anno.df$Relation_to_Island <- factor(meqtl.cpg.anno.df$Relation_to_Island, -->
